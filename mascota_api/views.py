...
def api_editar_mascota(request, pk):
    ...
    if request.method == 'PUT':
        mascota.nombre = request.PUT.get('nombre', mascota.nombre)
        mascota.especie = request.PUT.get('especie', mascota.especie)
        mascota.edad = request.PUT.get('edad', mascota.edad)
        mascota.save()
